...
const Features = () => {
  return (
    <section className="mt-[160px] ">
      <Container>
        <Flex className="gap-[60px] relative">
          <Image
            className="absolute right-[-50px] top-0 w-[150px]"
            src="/shape1.svg"
            alt="shape"
          />
          <Image
            className="absolute left-[-150px] bottom-[-50px] w-[150px]"
            src="/shape1.svg"
            alt="shape"
          />
          <div className="w-1/2">
          ...
          <div className="w-1/2">
            ...
            <p className=" font-darker font-medium xl:text-[28px] xl:leading-[110%] text-fadeText mt-[30px] xl:w-[457px]">
            ...
            <UL className="mt-[33px]">
              <LI className="flex gap-5 mb-5">
                ...
                <p className=" font-roboto font-normal xl:text-[16px] text-textoff xl:w-[417px]">
